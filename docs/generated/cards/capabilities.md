...
| Media | media | media_player | Yes | Own picker item | Type: play_pause, previous, next, volume, power, position, now_playing, tv_now_playing; Type: default, state; Controls: default, progress, play_pause; Maximum Volume: 1-100; Large Media Numbers | Visible |
...
| Weather | weather | weather | Yes | Own picker item | Type: default, today, tomorrow, hero, daily_strip, hourly_strip; Large Temperature Numbers; Animated Background | Visible |
