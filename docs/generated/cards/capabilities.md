...
| Media | media | media_player | Yes | Own picker item | Type: play_pause, previous, next, volume, position, now_playing, tv_now_playing; Type: default, state; Controls: default, progress, play_pause; Maximum Volume: 1-100; Large Media Numbers | Visible |
