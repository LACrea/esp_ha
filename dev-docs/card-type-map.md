...
| `media` | Media | `src/webserver/types/media.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h` | `media_player` | Yes | Type: play_pause, previous, next, volume, power, position, now_playing, tv_now_playing; Type: default, state; Controls: default, progress, play_pause; Maximum Volume; Large Media Numbers | Visible | Contract, Codec, Parser, HA, Modals, Backup |
